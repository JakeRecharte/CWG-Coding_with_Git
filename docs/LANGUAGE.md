# CWG Language Reference

The complete syntax and semantics of CWG. New here? Start with the
[README](README.md) for the concept and installation, then come back for the
full reference.
...
- [Merging](#merging)
- [Revert and Exception Handling](#revert-and-exception-handling)
